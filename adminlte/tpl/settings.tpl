		...
		<div class="accordion" id="settings" role="tablist" aria-multiselectable="true">
			<div class="accordion-item">
				<div class="section-subtitle-wrapper" role="tab" id="basic-settings">
					<h2 class="accordion-header">
						<button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#basic-settings-collapse">
							{{$h_basic}}
						</button>
					</h2>
				</div>
			...
			<div class="accordion-item">
				<div class="section-subtitle-wrapper" role="tab" id="notification-settings">
					<h2 class="accordion-header">
						<button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#notification-settings-collapse">
							{{$h_not}}
						</a>
					</h2>
				</div>
