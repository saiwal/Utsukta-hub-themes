<nav class="app-header navbar navbar-expand bg-body border-0 sticky-top"> <!--begin::Container-->
  <div class="container-fluid"> <!--begin::Start Navbar Links-->
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" id="notifications-btn-1" href="/notifications"> <i id="notifications-btn-icon-1" class="bi bi-excalamation-circle"></i> <span class="navbar-badge badge text-bg-info"></span> </a>
      </li>
			{{/if}}
