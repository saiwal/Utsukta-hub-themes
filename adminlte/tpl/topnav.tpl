<nav class="app-header navbar navbar-expand  bg-body-tertiary border-0 sticky-top"> <!--begin::Container-->
  <div class="container-fluid"> <!--begin::Start Navbar Links-->
    ...
    <ul class="navbar-nav ml-auto align-items-center justify-content-center">
      ...
      <li id="notifications-btn" class="nav-item dropdown notifications-btn"> <a class="nav-link" data-bs-toggle="dropdown" href="#" aria-expanded="false" data-bs-auto-close="outside"> <i id="notifications-btn-icon" class="bi bi-bell notifications-btn-icon"></i> <span class="navbar-badge badge text-bg-warning"></span> </a>
