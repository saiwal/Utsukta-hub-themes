<div class="section-title-wrapper app-content-header">
	<div class="float-end">
		<a href="cloud_tiles/{{$cpath}}" class="btn btn-sm btn-secondary"><i class="bi {{if $tiles}}bi-list{{else}}bi-grid{{/if}}"></i></a>
		{{if $actionspanel}}
		{{if $is_owner}}
		<a href="/sharedwithme" class="btn btn-sm btn-secondary"><i class="bi bi-download"></i>&nbsp;{{$shared}}</a>
		{{/if}}
