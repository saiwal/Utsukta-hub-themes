	<div id="thread-wrapper-{{$item.id}}" class="thread-wrapper{{if $item.toplevel}} {{$item.toplevel}} generic-content-wrapper card h-entry mb-5 {{else}} u-comment h-cite {{/if}}" data-b64mids='{{$item.mids}}'>
