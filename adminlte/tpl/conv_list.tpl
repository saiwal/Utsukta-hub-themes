	<div id="thread-wrapper-{{$item.id}}" class="thread-wrapper{{if $item.toplevel}} {{$item.toplevel}} generic-content-wrapper card card-primary h-entry mb-4 {{else}} u-comment h-cite {{/if}}" data-b64mids='{{$item.mids}}'>
