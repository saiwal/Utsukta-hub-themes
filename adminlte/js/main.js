		...
		if(orgHeight > divmore_height) {
			if(! $(this).hasClass('divmore') && $(this).has('div.no-collapse').length == 0) {
				$(this).readmore({
					...
					moreLink: '<a href="#" class="divgrow-showmore fakelink badge text-bg-info d-flex justify-content-center ms-5 me-5"><i class="bi bi-chevron-down align-middle divgrow-showmore-icon"></i>&nbsp;<span class="divgrow-showmore-label align-middle">' + aStr.divgrowmore + '</span></a>',
					lessLink: '<a href="#" class="divgrow-showmore fakelink badge text-bg-info d-flex justify-content-center ms-5 me-5"><i class="bi bi-chevron-up align-middle divgrow-showmore-icon"></i>&nbsp;<span class="divgrow-showmore-label align-middle">' + aStr.divgrowless + '</span></a>',
