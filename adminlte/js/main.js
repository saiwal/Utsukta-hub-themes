	...
	if (verb === 'comment') {
		...
		.then(obj => {
			...
			obj.result.forEach(e => {
				...
				modal_content.innerHTML += '<a href="' + e.url + '" class="btn col-2 d-flex flex-column align-items-center">' + mod + '<img src="' + e.photo + '" class="img-size-64 img-thumbnail shadow" loading="lazy"><small> ' + e.name + '</small></a>';
