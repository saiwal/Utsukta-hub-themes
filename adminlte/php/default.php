...
<body class="layout-fixed sidebar-expand-lg sidebar-mini bg-body-tertiary app-loaded sidebar-open">
  <div class="app-wrapper">
    ...
    <main class="app-main px-3 py-3" style="min-height: calc(100vh - 56px);">
      <div class="row">
        <div id="region_1" class="col-12 col-md-8 col-lg-8 col-xl-6">
          <?php if (x($page, 'content')) echo $page['content']; ?>
        </div>

        <div id="region_2" class="col-md-4 d-md-block col-lg-4 col-xl-3">
        ...
        <div id="region_3" class="d-none d-xl-block col-3">
