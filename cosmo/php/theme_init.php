...
head_add_js('/view/theme/cosmo/js/main.js');
...
head_add_css('/view/theme/cosmo/css/adminlte.min.css');
head_add_css('/view/theme/cosmo/css/bootstrap.min.css');
head_add_css('/view/theme/cosmo/css/overlayscrollbar.min.css');
head_add_css('/view/theme/cosmo/css/style.css');
...
head_add_js('/view/theme/cosmo/js/adminlte.min.js');
head_add_js('/view/theme/cosmo/js/overlayscrollbar.min.js');
