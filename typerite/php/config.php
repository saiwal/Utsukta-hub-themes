...
class typeriteConfig {
  ...
  function get() {
	...
	function post() {
		...
		/**/
		/*				set_pconfig(local_channel(), 'typerite', 'bootstrap', $bs->getCss());*/
		/*			} catch (\Exception $e) {*/
		/*				logger('scssphp: Unable to compile content');*/
		/*			}*/
		/*		}*/
		/*		else {*/
		/*			set_pconfig(local_channel(), 'typerite', 'bootstrap', '');*/
		/*		}*/
		/*	}*/
		/**/
		/*	set_pconfig(local_channel(), 'typerite', 'primary_color', $_POST['adminlte_primary_color']);*/
		/*	set_pconfig(local_channel(), 'typerite', 'success_color', $_POST['redbasic_success_color']);*/
		/*	set_pconfig(local_channel(), 'typerite', 'info_color', $_POST['redbasic_info_color']);*/
		/*	set_pconfig(local_channel(), 'typerite', 'warning_color', $_POST['redbasic_warning_color']);*/
		/*	set_pconfig(local_channel(), 'typerite', 'danger_color', $_POST['redbasic_danger_color']);*/
		/**/
		/*	set_pconfig(local_channel(), 'typerite', 'narrow_navbar', $_POST['redbasic_narrow_navbar']);*/
		/*	set_pconfig(local_channel(), 'typerite', 'navbar_dark_mode', $_POST['redbasic_navbar_dark_mode']);*/
		/*	set_pconfig(local_channel(), 'typerite', 'dark_mode', $_POST['redbasic_dark_mode']);*/
		/*	set_pconfig(local_channel(), 'typerite', 'nav_bg', $_POST['redbasic_nav_bg']);*/
		/*	set_pconfig(local_channel(), 'typerite', 'nav_bg_dark', $_POST['redbasic_nav_bg_dark']);*/
		/*	set_pconfig(local_channel(), 'typerite', 'background_color', $_POST['redbasic_background_color']);*/
		/*	set_pconfig(local_channel(), 'typerite', 'background_color_dark', $_POST['redbasic_background_color_dark']);*/
		/*	set_pconfig(local_channel(), 'typerite', 'background_image', $_POST['redbasic_background_image']);*/
		/*	set_pconfig(local_channel(), 'typerite', 'background_image_dark', $_POST['redbasic_background_image_dark']);*/
		/*	set_pconfig(local_channel(), 'typerite', 'font_size', $_POST['redbasic_font_size']);*/
		/*	set_pconfig(local_channel(), 'typerite', 'radius', $_POST['redbasic_radius']);*/
		/*	set_pconfig(local_channel(), 'typerite', 'converse_width', $_POST['redbasic_converse_width']);*/
		/*	set_pconfig(local_channel(), 'typerite', 'top_photo', $_POST['redbasic_top_photo']);*/
		/*	set_pconfig(local_channel(), 'typerite', 'reply_photo', $_POST['redbasic_reply_photo']);*/
		/*	set_pconfig(local_channel(), 'typerite', 'advanced_theming', $_POST['redbasic_advanced_theming']);*/
		/**/
