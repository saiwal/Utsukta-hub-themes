import{_ as e,f as t,g as n,s as r}from"./app-solid-P6NIHsRG.js";import{h as i,m as a,p as o,s,u as c}from"./app-web-BlIDY1k5.js";import{d as l}from"./app-routing-DVnanUVy.js";import{Ct as u,St as d,Yt as f,pn as p}from"./app-CI4GUA0N.js";import{t as m}from"./app-SubPageLayout-CTq-gJ9Q.js";var h=a(`<iframe style=width:100%;height:100vh;border:none;display:block>`),g=[`--color-base`,`--color-surface`,`--color-elevated`,`--color-overlay`,`--color-txt`,`--color-muted`,`--color-subtle`,`--color-rim`,`--color-rim-strong`,`--color-accent`,`--color-accent-muted`,`--color-accent-txt`,`--color-accent-fg`];function _(e,t){let n=getComputedStyle(document.documentElement);return`<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
</html>`}function v(t){return(()=>{var n=h();return e(e=>{var r=_(t.gameId,`/view/theme/solidified/assets/`),i=`Puzzle: ${t.gameId}`;return r!==e.e&&c(n,`srcdoc`,e.e=r),i!==e.t&&c(n,`title`,e.t=i),e},{e:void 0,t:void 0}),n})()}var y=a(`<p class="text-xs text-muted leading-relaxed"><a href=https://www.chiark.greenend.org.uk/~sgtatham/puzzles/ target=_blank rel="noopener noreferrer"class="underline hover:text-txt transition-colors">Simon Tatham's Portable Puzzle Collection</a> — MIT License`),b=a(`<div class="relative flex-1 min-h-0"><div class="absolute inset-0 z-10 cursor-default">`);function x(){let{t:a}=p(),c=l(),{helpMode:h}=u(),g=f.map(e=>({path:e.id,label:()=>String(a(e.labelKey)),icon:(()=>{let n=e.icon;return t(n,{class:`w-5 h-5 shrink-0`})})()})),_=n(()=>{let e=c.pathname.replace(/^\/games\/?/,``).split(`/`)[0];return f.some(t=>t.id===e)?e:f[0].id}),x=n(()=>f.find(e=>e.id===_())??f[0]),S=y();return t(m,{base:`/games`,items:g,get activeKey(){return _()},sidebarFooter:S,contentClass:`flex-1 min-h-0 overflow-hidden flex flex-col`,get children(){return t(r,{get when(){return x()},keyed:!0,children:n=>(()=>{var r=b(),a=r.firstChild;return i(d,a,()=>`games.${n.id}`),s(r,t(v,{get gameId(){return n.id}}),null),e(e=>o(a,`pointer-events:${h()?`auto`:`none`}`,e)),r})()})}})}export{x as default};