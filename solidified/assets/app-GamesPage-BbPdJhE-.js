import{C as e,M as t,N as n,O as r,h as i,m as a,p as o,s,u as c}from"./app-web-9kNHfgxH.js";import{d as l}from"./app-routing-BV7Kukwf.js";import{Xn as u,h as d,m as f,w as p}from"./app-CwfXpMCE.js";import{t as m}from"./app-SubPageLayout-DmjYrWg6.js";var h=a(`<iframe style=position:absolute;inset:0;width:100%;height:100%;border:none;display:block>`),g=[`--color-base`,`--color-surface`,`--color-elevated`,`--color-overlay`,`--color-txt`,`--color-muted`,`--color-subtle`,`--color-rim`,`--color-rim-strong`,`--color-accent`,`--color-accent-muted`,`--color-accent-txt`,`--color-accent-fg`];function _(e,t){let n=getComputedStyle(document.documentElement);return`<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
</html>`}function v(e){return(()=>{var t=h();return n(n=>{var r=_(e.gameId,`/view/theme/solidified/assets/`),i=`Puzzle: ${e.gameId}`;return r!==n.e&&c(t,`srcdoc`,n.e=r),i!==n.t&&c(t,`title`,n.t=i),n},{e:void 0,t:void 0}),t})()}var y=a(`<p class="text-xs text-muted leading-relaxed"><a href=https://www.chiark.greenend.org.uk/~sgtatham/puzzles/ target=_blank rel="noopener noreferrer"class="underline hover:text-txt transition-colors">Simon Tatham's Portable Puzzle Collection</a> — MIT License`),b=a(`<div class="relative flex-1 min-h-0"><div class="absolute inset-0 z-10 cursor-default">`);function x(){let{t:a}=u(),c=l(),{helpMode:h}=d(),g=p.map(e=>({path:e.id,label:()=>String(a(e.labelKey)),icon:(()=>{let t=e.icon;return r(t,{class:`w-5 h-5 shrink-0`})})()})),_=t(()=>{let e=c.pathname.replace(/^\/games\/?/,``).split(`/`)[0];return p.some(t=>t.id===e)?e:p[0].id}),x=t(()=>p.find(e=>e.id===_())??p[0]);return r(m,{base:`/games`,items:g,get activeKey(){return _()},sidebarFooter:y(),contentClass:`flex-1 min-h-0 overflow-hidden flex flex-col`,get children(){return r(e,{get when(){return x()},keyed:!0,children:e=>(()=>{var t=b(),a=t.firstChild;return i(f,a,()=>`games.${e.id}`),s(t,r(v,{get gameId(){return e.id}}),null),n(e=>o(a,`pointer-events:${h()?`auto`:`none`}`,e)),t})()})}})}export{x as default};