import{t as e}from"./app-vendor-dompurify-CYRiAeUx.js";import{t}from"./app-bbcode-D-vPycEY.js";import{i as n,t as r}from"./app-postCrypto-BoOLB92E.js";function i(i){let a=i.target.closest(`[data-crypt-payload]`);if(!a)return!1;i.stopPropagation();let o=a.dataset.cryptPayload??``,s=n(o),c=document.createElement(`form`);return c.className=`hz-decrypt-form flex flex-col gap-2 my-1`,c.innerHTML=`
