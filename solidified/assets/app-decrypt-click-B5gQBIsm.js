import{t as e}from"./app-vendor-dompurify-D-kBbLew.js";import{t}from"./app-bbcode-Q8-4eIL7.js";import{r as n,t as r}from"./app-postCrypto-DZJN3QbR.js";function i(i){let a=i.target.closest(`[data-crypt-payload]`);if(!a)return!1;i.stopPropagation();let o=a.dataset.cryptPayload??``,s=n(o),c=document.createElement(`form`);return c.className=`hz-decrypt-form flex flex-col gap-2 my-1`,c.innerHTML=`
