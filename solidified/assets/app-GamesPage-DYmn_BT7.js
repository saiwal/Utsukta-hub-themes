import{C as e,M as t,N as n,O as r,h as i,m as a,p as o,s,u as c}from"./app-web-BeXRvOD7.js";import{d as l}from"./app-routing-DXOCapzW.js";import{It as u,ct as d,lt as f,va as p}from"./app-CS9_GdSC.js";import{t as m}from"./app-SubPageLayout-BZ4RJ1Yc.js";var h=a(`<iframe style=width:100%;height:100vh;border:none;display:block>`),g=[`--color-base`,`--color-surface`,`--color-elevated`,`--color-overlay`,`--color-txt`,`--color-muted`,`--color-subtle`,`--color-rim`,`--color-rim-strong`,`--color-accent`,`--color-accent-muted`,`--color-accent-txt`,`--color-accent-fg`];function _(e,t){let n=getComputedStyle(document.documentElement);return`<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
