import{t as e}from"./app-renderBody-2MNGFbXI.js";import{t}from"./app-vendor-dompurify-CYRiAeUx.js";import{i as n,t as r}from"./app-postCrypto-DG18qIPD.js";function i(i){let a=i.target.closest(`[data-crypt-payload]`);if(!a)return!1;i.stopPropagation();let o=a.dataset.cryptPayload??``,s=n(o),c=document.createElement(`form`);return c.className=`hz-decrypt-form flex flex-col gap-2 my-1`,c.innerHTML=`
    <span class="text-muted text-xs">🔒 ${t.sanitize(s||`Enter passphrase`)}</span>
