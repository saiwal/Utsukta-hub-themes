import{C as e,M as t,N as n,O as r,h as i,m as a,p as o,s,u as c}from"./app-web-9kNHfgxH.js";import{d as l}from"./app-routing-BV7Kukwf.js";import{O as u,mr as d,v as f,y as p}from"./app-0sR0TZYy.js";import{t as m}from"./app-SubPageLayout-Crss0K-4.js";var h=a(`<iframe style=position:absolute;inset:0;width:100%;height:100%;border:none;display:block>`),g=[`--color-base`,`--color-surface`,`--color-elevated`,`--color-overlay`,`--color-txt`,`--color-muted`,`--color-subtle`,`--color-rim`,`--color-rim-strong`,`--color-accent`,`--color-accent-muted`,`--color-accent-txt`,`--color-accent-fg`];function _(e,t){let n=getComputedStyle(document.documentElement);return`<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
