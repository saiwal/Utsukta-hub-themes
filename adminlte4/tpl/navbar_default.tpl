<nav class="app-header navbar navbar-expand bg-body border-0 sticky-top"> <!--begin::Container-->
  <div class="container-fluid"> <!--begin::Start Navbar Links-->
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li id="notifications-btn" class="nav-item dropdown"> <a class="nav-link" data-bs-toggle="dropdown" href="#"
          aria-expanded="false" data-bs-auto-close="outside"> <i id="notifications-btn-icon" class="bi bi-bell"></i>
          <span class="navbar-badge badge text-bg-warning"></span> </a>
          ...
          <div id="notifications_wrapper" class="ms-3 me-3 small">
            ...
            <div id="notifications" class="navbar-nav row mb-0">
              ...
              <div id="nav-{{$notification.type}}-sub"
                class="pe-0 rounded-bottom border border-start-0 border-end-0 border-bottom-0 list-group list-group-flush collapse notification-content"
