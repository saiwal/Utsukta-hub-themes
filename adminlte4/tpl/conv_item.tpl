...
<button id="hide-comments-icon-{{$item.id}}" class="btn btn-sm btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapsed-comments-{{$item.id}}" aria-expanded="false" aria-controls="collapsed-comments-{{$item.id}}">
