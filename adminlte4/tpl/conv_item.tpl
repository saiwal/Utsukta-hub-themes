...
<div id="hide-comments-outer-{{$item.parent}}" class="hide-comments-outer fakelink small btn btn-sm btn-primary-outline text-bg-info ms-5 me-5 mb-2" onclick="showHideComments({{$item.id}});">
