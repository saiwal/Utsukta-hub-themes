...
<script>
	...
	function jotAddOption() {
		var option = '<div class="jot-poll-option mb-3"><input class="w-100 code" name="poll_answers[]" type="text" value="" placeholder="Option"><div class="poll-option-close input-group-text"><i class="bi bi-x-lg"></i></div></div>';
