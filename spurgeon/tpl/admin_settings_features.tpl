		...
		<div class="accordion-item">
			<div class="section-subtitle-wrapper" role="tab" id="{{$g}}-settings-title">
				<div class="accordion-header">
					<button class="accordion-button m-0 h6 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#{{$g}}-settings-content" aria-expanded="false" aria-controls="{{$g}}-settings-collapse">
						{{$f.0}}
					</button>
				</div>
			</div>
