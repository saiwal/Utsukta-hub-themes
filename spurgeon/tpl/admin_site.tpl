  ...
  <div class="accordion accordion-flush" id="accordionExample">
    <div class="accordion-item">
      <div class="accordion-header">
        <button class="accordion-button m-0 h6" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
    ...
    <div class="accordion-item">
      <div class="accordion-header">
        <button class="accordion-button collapsed m-0 h6" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo"
    ...
    <div class="accordion-item">
      <div class="accordion-header">
        <button class="accordion-button collapsed m-0 h6" type="button" data-bs-toggle="collapse"
