...
class keepitsimpleConfig {
  ...
  function get() {
		...
		$arr['primary_color'] = get_pconfig(local_channel(),'keepitsimple', 'primary_color');
		$arr['success_color'] = get_pconfig(local_channel(),'keepitsimple', 'success_color');
		$arr['info_color'] = get_pconfig(local_channel(),'keepitsimple', 'info_color');
		$arr['warning_color'] = get_pconfig(local_channel(),'keepitsimple', 'warning_color');
		$arr['danger_color'] = get_pconfig(local_channel(),'keepitsimple', 'danger_color');
		$arr['dark_mode'] = get_pconfig(local_channel(),'keepitsimple', 'dark_mode');
		$arr['navbar_dark_mode'] = get_pconfig(local_channel(),'keepitsimple', 'navbar_dark_mode');
		$arr['narrow_navbar'] = get_pconfig(local_channel(),'keepitsimple', 'narrow_navbar' );
		$arr['nav_bg'] = get_pconfig(local_channel(),'keepitsimple', 'nav_bg' );
		$arr['nav_bg_dark'] = get_pconfig(local_channel(),'keepitsimple', 'nav_bg_dark' );
		$arr['bgcolor'] = get_pconfig(local_channel(),'keepitsimple', 'background_color' );
		$arr['bgcolor_dark'] = get_pconfig(local_channel(),'keepitsimple', 'background_color_dark' );
		$arr['background_image'] = get_pconfig(local_channel(),'keepitsimple', 'background_image' );
		$arr['background_image_dark'] = get_pconfig(local_channel(),'keepitsimple', 'background_image_dark' );
		$arr['font_size'] = get_pconfig(local_channel(),'keepitsimple', 'font_size' );
		$arr['radius'] = get_pconfig(local_channel(),'keepitsimple', 'radius' );
		$arr['converse_width']=get_pconfig(local_channel(),"keepitsimple","converse_width");
		$arr['top_photo']=get_pconfig(local_channel(),"keepitsimple","top_photo");
		$arr['reply_photo']=get_pconfig(local_channel(),"keepitsimple","reply_photo");
		$arr['advanced_theming'] = get_pconfig(local_channel(), 'keepitsimple', 'advanced_theming');
	...
	function post() {
		...
		/**/
		/*				set_pconfig(local_channel(), 'keepitsimple', 'bootstrap', $bs->getCss());*/
		/*			} catch (\Exception $e) {*/
		/*				logger('scssphp: Unable to compile content');*/
		/*			}*/
		/*		}*/
		/*		else {*/
		/*			set_pconfig(local_channel(), 'keepitsimple', 'bootstrap', '');*/
		/*		}*/
		/*	}*/
		/**/
		/*	set_pconfig(local_channel(), 'keepitsimple', 'primary_color', $_POST['adminlte_primary_color']);*/
		/*	set_pconfig(local_channel(), 'keepitsimple', 'success_color', $_POST['redbasic_success_color']);*/
		/*	set_pconfig(local_channel(), 'keepitsimple', 'info_color', $_POST['redbasic_info_color']);*/
		/*	set_pconfig(local_channel(), 'keepitsimple', 'warning_color', $_POST['redbasic_warning_color']);*/
		/*	set_pconfig(local_channel(), 'keepitsimple', 'danger_color', $_POST['redbasic_danger_color']);*/
		/**/
		/*	set_pconfig(local_channel(), 'keepitsimple', 'narrow_navbar', $_POST['redbasic_narrow_navbar']);*/
		/*	set_pconfig(local_channel(), 'keepitsimple', 'navbar_dark_mode', $_POST['redbasic_navbar_dark_mode']);*/
		/*	set_pconfig(local_channel(), 'keepitsimple', 'dark_mode', $_POST['redbasic_dark_mode']);*/
		/*	set_pconfig(local_channel(), 'keepitsimple', 'nav_bg', $_POST['redbasic_nav_bg']);*/
		/*	set_pconfig(local_channel(), 'keepitsimple', 'nav_bg_dark', $_POST['redbasic_nav_bg_dark']);*/
		/*	set_pconfig(local_channel(), 'keepitsimple', 'background_color', $_POST['redbasic_background_color']);*/
		/*	set_pconfig(local_channel(), 'keepitsimple', 'background_color_dark', $_POST['redbasic_background_color_dark']);*/
		/*	set_pconfig(local_channel(), 'keepitsimple', 'background_image', $_POST['redbasic_background_image']);*/
		/*	set_pconfig(local_channel(), 'keepitsimple', 'background_image_dark', $_POST['redbasic_background_image_dark']);*/
		/*	set_pconfig(local_channel(), 'keepitsimple', 'font_size', $_POST['redbasic_font_size']);*/
		/*	set_pconfig(local_channel(), 'keepitsimple', 'radius', $_POST['redbasic_radius']);*/
		/*	set_pconfig(local_channel(), 'keepitsimple', 'converse_width', $_POST['redbasic_converse_width']);*/
		/*	set_pconfig(local_channel(), 'keepitsimple', 'top_photo', $_POST['redbasic_top_photo']);*/
		/*	set_pconfig(local_channel(), 'keepitsimple', 'reply_photo', $_POST['redbasic_reply_photo']);*/
		/*	set_pconfig(local_channel(), 'keepitsimple', 'advanced_theming', $_POST['redbasic_advanced_theming']);*/
		/**/
	...
	function form($arr) {
		...
		$expert = false;
		if(get_pconfig(local_channel(), 'keepitsimple', 'advanced_theming')) {
			$expert = true;
		}
