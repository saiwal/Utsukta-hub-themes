  ...
  <div class="section-title-wrapper app-content-header clearfix">
    <div class="float-end">
      <div class="dropdown">
        ...
        <div class="btn-group">
          <button id="prev-btn" class="btn btn-secondary btn-sm" title="{{$prev}}"><i
              class="bi bi-chevron-left"></i></button>
          <button id="today-btn" class="btn btn-secondary btn-sm" title="{{$today}}"><span id="events-spinner"
              class="spinner s"></span><i class="bi bi-crosshair"
              style="display: none; padding: 0.065rem;"></i></button>
          <button id="next-btn" class="btn btn-secondary btn-sm" title="{{$next}}"><i
  ...
  <div class="section-content-tools-wrapper" style="display: none">
    <div class="mb-3">
        ...
        <div id="event_form_wrapper" style="display: none">
          <form id="event_form" method="post" action="" class="acl-form" data-form_id="event_form"
            data-allow_cid='{{$allow_cid}}' data-allow_gid='{{$allow_gid}}' data-deny_cid='{{$deny_cid}}'
            data-deny_gid='{{$deny_gid}}'>
            ...
            <select id="calendar_select" name="target" class="form-control mb-3">
              ...
              <optgroup label="{{$calendar_optiopns_label.1}}">
                ...
                <option value="{{$writable_calendar.id.0}}:{{$writable_calendar.id.1}}">
                  {{$writable_calendar.displayname}}{{if $writable_calendar.sharer}}
                  ({{$writable_calendar.sharer}}){{/if}}</option>
                {{/foreach}}
              </optgroup>
            </select>
            {{if $timezone_select}}
            ...
            <div id="more_block" style="display: none;">
              ...
              <div id="id_categories_wrapper" class="mb-3">
                ...
                <input name="categories" id="id_categories" class="form-control" type="text" value="{{$categories}}"
            ...
            <div class="mb-3">
              <div class="float-end">
                <button id="event_more" type="button" class="btn btn-secondary btn-sm"><i class="bi bi-caret-down"></i>
                  {{$more}}</button>
                <button id="dbtn-acl" class="btn btn-secondary btn-sm d-none" type="button" data-bs-toggle="modal"
                  data-bs-target="#aclModal"><i id="jot-perms-icon" class="bi bi-{{$lockstate}}"></i></button>
