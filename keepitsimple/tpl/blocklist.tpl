<div class="generic-content-wrapper">
  <div class="section-title-wrapper app-content-header">
    {{if $editor}}
    <div class="float-end">
      <button id="webpage-create-btn" class="btn btn-sm btn-success" onclick="openClose('block-editor');"><i
      ...
      <table id="block-list-table" class="table">
        ...
        <tr id="block-list-item-{{$item.url}}">
          ...
          <td class="webpage-list-tool">
            {{if $edit}}
            <a href="#" title="{{$delete}}"
              onclick="dropItem('item/drop/{{$item.url}}', '#block-list-item-{{$item.url}}'); return false;"><i
